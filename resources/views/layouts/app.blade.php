...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="background: linear-gradient(145deg,#ff006a,#9c03ff)">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item"><a href="" class="nav-link">Latest</a></li>
                    ...
                    <li class="nav-item"><a href="" class="nav-link">Educations</a></li>
